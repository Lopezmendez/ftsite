      ...
      <main>
        ...
        <div className="help-sections">
          <div className="section">
            <img src="src/branches.png" alt="Branches" />
            <h2>Branches</h2>
          ...
          <div className="section">
            <img src="src/icon-account.png" alt="Manage your account" />
          ...
          <div className="section">
            <img src="src/icon-organizations.png" alt="Manage organizations" />
          ...
          <div className="section">
            <img src="src/icon-billing.png" alt="Manage billing" />
          ...
          <div className="section">
            <img src="src/icon-authenticate.png" alt="Authenticate to Abstract" />
          ...
          <div className="section">
            <img src="src/icon-comment.png" alt="Abstract support" />
